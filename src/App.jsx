      ...
      <div className="relative z-10">
        ...
        <nav className="flex items-center justify-between px-6 py-4 border-b border-white/5 text-sm backdrop-blur-sm bg-[#050505]/50 sticky top-0 z-50">
          <div className="flex items-center gap-8">
            <div className="text-xl font-black tracking-wider text-white flex items-center">
          ...
          <div className="flex items-center gap-6 font-medium">
            ...
            <button className="bg-[#00d2ff] text-black font-bold px-5 py-2.5 rounded-md shadow-[0_0_15px_rgba(0,210,255,0.4)] hover:bg-[#b3f0ff] hover:shadow-[0_0_25px_rgba(0,210,255,0.8)] hover:-translate-y-0.5 transition-all duration-300">
              Start Project
            </button>
          </div>
        </nav>
        ...
        <main className="max-w-7xl mx-auto px-6 pt-16 md:pt-20">
          ...
          {/* TOP CENTER: Hero Title (One Line) */}
          <div className="text-center max-w-5xl mx-auto mb-20">
            <h1 className="text-3xl md:text-5xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight leading-tight mb-6">
              Build<span className="text-[#00d2ff] drop-shadow-[0_0_12px_rgba(0,210,255,0.6)]">Ex</span>: <span className="text-gray-100">Build Your Idea Into Reality</span>
            </h1>
          ...
          {/* SPLIT SECTION: Form (Left) & Cards (Right) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start relative z-10">
            ...
            {/* RIGHT SIDE: Header + 2x2 Services Grid */}
            <div className="flex flex-col">
              
              {/* FIXED SUB-HEADER & INLINE RIGHT ARROW */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pb-20">
                ...
                <div className="bg-[#0f0f0f]/80 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 hover:border-[#00d2ff]/60 hover:shadow-[0_0_30px_rgba(0,210,255,0.15)] hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden flex flex-col h-full justify-center">
                  ...
                  <h3 className="text-xl font-bold text-white group-hover:text-[#00d2ff] transition-all mb-2">Commercial Websites</h3>
                ...
                <div className="bg-[#0f0f0f]/80 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 hover:border-[#00d2ff]/60 hover:shadow-[0_0_30px_rgba(0,210,255,0.15)] hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden flex flex-col h-full justify-center">
                  ...
                  <h3 className="text-xl font-bold text-white group-hover:text-[#00d2ff] transition-all mb-2">Custom Webpage</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">Highly secure, authenticated environments for your clients or employees to interact with your data.</p>
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-col md:flex-row justify-between gap-8 md:gap-0">
                ...
                <div className="flex flex-row md:flex-col items-center gap-4 md:gap-3 group">
                  ...
                  <div className="text-left md:text-center">
                    <h4 className="text-white font-bold text-sm">Idea</h4>
                    <p className="text-gray-500 text-xs mt-0.5">Blueprint approved</p>
                  </div>
                </div>
                {/* Stage 2 */}
                <div className="flex flex-row md:flex-col items-center gap-4 md:gap-3 group">
                  ...
                  <div className="text-left md:text-center">
                    <h4 className="text-white font-bold text-sm">Working</h4>
                    <p className="text-gray-500 text-xs mt-0.5">Core engine built</p>
                  </div>
                </div>
                {/* Stage 3 (Active) */}
                <div className="flex flex-row md:flex-col items-center gap-4 md:gap-3 group relative">
                  ...
                  <div className="text-left md:text-center">
                    <h4 className="text-[#00d2ff] font-bold text-sm drop-shadow-[0_0_5px_rgba(0,210,255,0.6)]">Almost Done</h4>
                    <p className="text-[#00d2ff]/70 text-xs mt-0.5">QA & Testing</p>
                  </div>
                </div>
                {/* Stage 4 */}
                <div className="flex flex-row md:flex-col items-center gap-4 md:gap-3 group">
                  ...
                  <div className="text-left md:text-center">
                    <h4 className="text-gray-400 font-bold text-sm">Final Touch</h4>
                    <p className="text-gray-600 text-xs mt-0.5">UI Polish</p>
                  </div>
                </div>
                {/* Stage 5 */}
                <div className="flex flex-row md:flex-col items-center gap-4 md:gap-3 group">
                  ...
                  <div className="text-left md:text-center">
                    <h4 className="text-gray-400 font-bold text-sm">Web is Live</h4>
                    <p className="text-gray-600 text-xs mt-0.5">Deployed</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* 3. FOOTER SECTION                            */}
        {/* ========================================== */}
        <footer className="border-t border-gray-800/60 bg-[#0a0a0a]/80 backdrop-blur-md pt-16 pb-8">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
              ...
              <div>
                ...
                <ul className="flex flex-col gap-3">
                  <li><a href="#" className="text-gray-400 hover:text-[#00d2ff] hover:translate-x-1 transition-all duration-300 text-sm inline-block">About Us</a></li>
